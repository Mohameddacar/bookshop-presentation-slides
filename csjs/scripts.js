const SLIDES = [
    {
        ...
        html: `<div class="feature-grid" style="grid-template-columns: 1fr; text-align: center;">
                  <div class="feature-card" style="border-top: 4px solid var(--accent-blue); padding: 4rem 2rem;">
                      ...
                      <h2 style="font-size: 3rem; font-weight: 800; color: var(--text-primary); margin-bottom: 1.5rem; letter-spacing: -1px;">BOOKSHOP SYSTEM</h2>
    ...
    },
    {
        ...
        title: "Project Team",
        subtitle: "The research and development team for the Bookshop System.",
    ...
    },
    {
        ...
        subtitle: "General Objective: To design and develop a web-based Bookshop System that improves inventory management, automates sales operations, and supports business decision-making.",
    ...
    },
    {
        ...
        title: "Conclusion",
        subtitle: "The Bookshop System replaced fragmented manual records with one integrated web-based platform.",
        html: `<div style="display: flex; flex-direction: column; gap: 2rem;">
